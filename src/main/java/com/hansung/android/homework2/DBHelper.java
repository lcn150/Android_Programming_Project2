...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public Cursor getAllUsersByMethod() {  //데이터베이스에 저장되어있는 맛집을 가져오기 위한 메소드방식
        SQLiteDatabase db = getReadableDatabase();
        return db.query(RestaunrantContract.Users.Restaurant_TABLE_NAME,null,null,null,null,null,null);
    }

    public Cursor getAllUsersBySQL(int resId) {  //데이터베이스에 저장되어있는 맛집을 가져오기 위한 SQL
